...
<div class="container">
    ...
    <!-- Profil Pengguna di Sisi Kiri (Ditempatkan di atas) -->
    @auth
    <div class="row mt-5">
        <div class="col-md-4">
            <div class="bg-white rounded shadow-sm p-4">
                ...
                <div class="d-flex align-items-center mb-4">
                    <img src="{{ asset('storage/' . Auth::user()->avatar) }}" alt="Avatar" class="rounded-circle me-4" style="width: 120px; height: 120px; object-fit: cover;">
                    <div>
                ...
                <a href="{{ url('/profile') }}" class="btn btn-primary w-100 py-2 mt-3">Edit Profil</a>
            </div>
        </div>
    </div>
    @endauth
    ...
    <div class="row mt-4">
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4">
            <div class="card shadow-lg border-0 h-100">
                <img src="{{ asset('storage/' . $product->image) }}" class="card-img-top" alt="{{ $product->name }}" style="height: 200px; object-fit: cover; border-radius: 10px;">
